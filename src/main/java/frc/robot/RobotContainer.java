...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        try {
            ...
            SmartDashboard.putString("Exception", LocalDateTime.now().toString() + " : " + e.toString());
            SmartDashboard.putString("Exception Trace", e.getStackTrace().toString());
        } 
    ...
    private void configureBindings() {
        ...
        // );
        // new JoystickButton(m_stick1, DriveConstants.kTurnButton).onTrue(new Turn(90,
        // m_drivetrain));
    }
